        ...
        <div class="row">
            ...
            <?php
                ...
                foreach ($dirs as $dir){
                    ...
                    $pics = glob($dir."/*");
                    foreach($pics as $pic){
                        echo "<div class='imgAlbum col-lg-3 col-md-4 col-sm-4 col-xs-6 filter $map'> <a href='./$pic' data-toggle='lightbox' data-gallery='example-gallery'> <img class='imgAlbum' src='./$pic'/> </a> </div>";
                    }
                }
                ?>
        </div>

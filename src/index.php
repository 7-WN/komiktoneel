      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            >
            <a class="nav-item nav-link" href="./over.html">Over</a>
            <a class="nav-item nav-link" href="./reserveren.html">Reserveren</a>
            <a class="nav-item nav-link" href="./voorstellingen.html"
              >Voorstellingen</a
            >
            <a class="nav-item nav-link" href="./album.html">Foto's</a>
    ...
    <div class="container">
      <main>
        ...
        <section class="reservatie">
          <img
            class="affiche"
            src="./images/Affiche TomDickHarry.png"
            alt="Affiche huidige toneel"
          />
